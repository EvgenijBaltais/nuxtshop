...
mounted(){
            ...
            axios.get('//79.174.12.75:3001/images/id', {
                method: 'GET',
                params: {
                    'id': this.$route.params.item
                }
                ...
                document.querySelector('.product-main__right').addEventListener('click', function(){
                    myProductGlide.go('>')
                })

                document.querySelector('.product-main__left').addEventListener('click', function(){
                    myProductGlide.go('<')
                })
